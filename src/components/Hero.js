...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/diengabzo/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-12 flex justify-center lg:justify-start space-x-6">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-200/50 dark:border-gray-700/50"
                  >
                    {social.icon}
                  </a>
                ))}
